...
const BAThesis = ({ standalone = false }: { standalone?: boolean } = {}) => (
	<div className={style.wrapper}>
		<div className={style.innerWrapper}>
			<div
				className={cx(style.logo, style.react, standalone && style.standalone)}
			>
			...
			<div
				className={cx(style.logo, style.vue, standalone && style.standalone)}
			>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 261.8 226.7">
					<path
						fill="#41b883"
						d="M161.1 0l-30.2 52.4L100.6 0H0l130.9 226.7L261.7 0z"
					/>
					<path
						fill="#34495e"
						d="M161.1 0l-30.2 52.4L100.6 0H52.3L131 136 209.4 0z"
					/>
				</svg>
			</div>
			<div
				className={cx(style.logo, style.svelte, standalone && style.standalone)}
			>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98.1 118">
					<path
						fill="#ff3e00"
						d="M91.8 15.6A36 36 0 0043.6 5.2L16.1 22.8A31.3 31.3 0 001.9 43.9a32.7 32.7 0 003.3 21.3 33.6 33.6 0 001 37.2 36 36 0 0048.2 10.4l27.5-17.5a31.3 31.3 0 0014.2-21.1c1.3-7.3.2-14.8-3.3-21.3a33 33 0 00-1-37.3"
					/>
					<path
						fill="#fff"
						d="M40.9 103.9a21.8 21.8 0 01-23.4-8.7A20.3 20.3 0 0114 79.9l.6-2.6.5-1.6 1.4 1c3.3 2.4 6.9 4.2 10.8 5.4l1 .3-.1 1a6.6 6.6 0 009.9 6.1L65.5 72a5.7 5.7 0 002.6-3.8c.3-1.6-.1-3.3-1-4.6a6.6 6.6 0 00-8.8-1.9l-10.5 6.7a21.8 21.8 0 01-29-6.3 20.2 20.2 0 01-3.4-15.3A19 19 0 0124 34.1l27.5-17.5c1.7-1.1 3.6-1.9 5.6-2.5a21.8 21.8 0 0123.4 8.7 20.3 20.3 0 012.8 17.9l-.5 1.6-1.4-1a36.5 36.5 0 00-10.8-5.4l-1-.3.1-1c.1-1.4-.3-2.9-1.1-4.1a6.6 6.6 0 00-8.8-1.9L32.4 46.1c-1.4.9-2.3 2.2-2.6 3.8s.1 3.3 1 4.6a6.6 6.6 0 008.8 1.9l10.5-6.7c1.7-1.1 3.6-1.9 5.6-2.5a21.8 21.8 0 0123.4 8.7c3.2 4.4 4.4 9.9 3.5 15.3A19 19 0 0174 83.9l-27.5 17.5a21.8 21.8 0 01-5.6 2.5"
					/>
				</svg>
			</div>
		</div>
